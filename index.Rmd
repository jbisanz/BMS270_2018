...
```{r}
adonis(weighted~Timepoint, strata=metadata$anonymized_name, data=metadata) #include strata
```
...
results.deseq %>%
  ...
  mutate(Significant=if_else(is.na(Significant), "Not Significant", "Significant")) %>% #catch NAs from when their was no FDR
